...
Analyze all open tasks and recommend which to work on next. Output a ranked list of ALL eligible tasks to stdout. Do NOT create or modify any files.
...
For each eligible task, in rank order (1 = highest priority):

**N. [repo-relative task path]** — [goal]
- **Why now:** [what makes this high priority — blocking others, high impact, strategic alignment]
- **Blockers:** [what must be true before starting, or "None"]
- **Complexity:** Low / Medium / High — [brief justification]

(Repeat for every eligible task. N starts at 1 and increments.)
